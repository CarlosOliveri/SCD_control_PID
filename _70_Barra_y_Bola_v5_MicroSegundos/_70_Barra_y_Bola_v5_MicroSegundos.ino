...
int dcal [] = { // Calibracion de ADC a Distancia
  -193, -160, -110, -160, 0, 40, 60, 90, 120};
  //-110, -100, -90, -50, -10, 0, 30, 70, 110, 150, 190};

int ADCcal [] = {
  //970, 742, 558, 483, 372, 293, 231, 189, 177};
  177, 189, 231, 293, 372, 483, 558, 742, 970};
  //763, 760, 711, 520, 418, 407, 371, 324, 310, 304, 292};
...
float pos;
float reposo = 1500; // valor que mantiene la barra horizontal
